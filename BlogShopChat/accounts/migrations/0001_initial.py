    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=14, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in the format +989999999999. Up to 10 digits allowed.', regex='^\\+98\\d{10}$')], verbose_name='Phone number')),
